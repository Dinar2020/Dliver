...
from .views import VendaCreateView, ProdutoCreateView, VendaListView, VendaUpdateView, BebidaCreateView, BebidaListView, BebidaUpdateView, HamburgueCreateView, HamburgueListView, HamburgueUpdateView, PizzaCreateView, PizzaListView, PizzaUpdateView, PassaporteCreateView, PassaporteUpdateView, PassaporteListView
...
urlpatterns = [
    ...
    path('cadastrar/hamburgue', PassaporteCreateView.as_view(), name="cadastrar_pizza"),
    path('listar/hamburgue', PassaporteListView.as_view(), name="listar_pizza"),
